...
function main() {
    ...
    var globals = { lightPos: new Vector(180,100,20),  // light over right upper rect
                    lightCol: new Color(255,255,255)}; // light is white
    var tlAttribs = { diffuse: new Color(50,200,255)};    // all four rect verts blue
    var trAttribs = { diffuse: new Color(100,100,255)};
    var brAttribs = { diffuse: new Color(100,50,255)};
    var blAttribs = { diffuse: new Color(50,50,255)};
